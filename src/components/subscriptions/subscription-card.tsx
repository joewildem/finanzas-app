...
// CU-079 — card de una suscripción. Junto al monto de cobro va el costo anualizado, que es el
// número que hace evidente qué vale la pena cancelar: "$139.00/mo" se lee barato, "$1,668.00/yr"
// no. Un pago único no tiene equivalente anual, así que ahí se omite.
